...
const persistConfig = {
    key: 'root',
    storage,
    blacklist: ['nav', 'settingsReducer', 'epgByGenresReducer', 'vodByGenresReducer', 'latestVODByGenresReducer', 'categoryReducer', 'vodByGenresReducer', 'liveEpgZapperReducer', 'playlistReducer'],
