        ...
        return (
            <View style={styles.topContainer}>
                ...
                <TouchableOpacity style={{position: 'absolute', bottom: 25, right: 25}}
                                  onPress={this._navigateBrightcovePlayerScreen}>
        ...
        return (
            <View style={{width: '100%', height: height}} key={item}>
                ...
                <View style={styles.topContainer}>
                    ...
                    <TouchableOpacity style={{position: 'absolute', top: 30, left: 20, width: 50, height: 50}}
        ...
        return (
            <View
                ...
                <Swiper loop={false} loadMinimal={true} loadMinimalSize={1} onIndexChanged={this._onSwiperIndexChanged}
                        ...
                        removeClippedSubviews={false} index={index}>
                    {
                        epg.map(value => this._renderUpperPage(epg, value))
                    }
                </Swiper>
                {this._renderTopContainer(epg, index, isLive)}
                <TouchableOpacity style={{position: 'absolute', top: 30, left: 30, width: 50, height: 50}}
                                  onPress={() => this.props.navigation.goBack()}>
                    <Image source={require('../../assets/ic_dismiss_modal.png')}/>
                </TouchableOpacity>
            </View>
