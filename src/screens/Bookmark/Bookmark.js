                ...
                <View style={styles.bookmarkLabelContainer}>
                    ...
                    <View style={styles.textInputContainer}>
                        <TextInput placeholder={'Emissions'} onChangeText={text => this.setState({inputText: text})}
                                   ...
                                   inlineImageLeft='ic_search' inlineImagePadding={8}
                                   underlineColorAndroid='rgba(0,0,0,0)'/>
                        <TouchableOpacity onPress={() => this.setState({inputText: ''})} style={{
                            position: 'absolute',
                            right: 0,
                            top: 0,
                            paddingRight: 7,
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Modal animationType={'fade'} transparent={true} visible={this.state.openModal} type={'bookmark'}
                       onClosePress={this._toggleModal} data={this.state.data}/>
                <HeaderLabel position={'begin'} text={'MY SCHEDULED RECORD'} keyExtractor={this._keyExtractor} showBackButton={false}/>
                <SectionList
