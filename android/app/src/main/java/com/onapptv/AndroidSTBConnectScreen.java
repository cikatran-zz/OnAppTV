...
public class AndroidSTBConnectScreen extends FrameLayout {
    ...
    public AndroidSTBConnectScreen(@NonNull Context context) {
        super(context);
        inflate(context, com.onapptv.android_stb_connect.R.layout.screen, this);
        initialize(context);
    }
    ...
    private void initialize(Context con) {
        ...
        launch_View = findViewById(com.onapptv.android_stb_connect.R.id.launch_view);
        bWebView = findViewById(com.onapptv.android_stb_connect.R.id.webView);
//        设置编码
