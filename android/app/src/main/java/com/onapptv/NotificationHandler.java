...
import static com.onapptv.MainApplication.IS_ENABLED_NOTIFICATION;
import static com.onapptv.MainApplication.NOTIFICATION_PREF;
...
public class NotificationHandler extends NotificationListenerService {
    ...
    public void onNotificationReceived(String from, Bundle data) {
        ...
        if (sharedPreferences.getBoolean(IS_ENABLED_NOTIFICATION, true)) {
