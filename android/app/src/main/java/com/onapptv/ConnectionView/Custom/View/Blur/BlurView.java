package com.onapptv.ConnectionView.Custom.View.Blur;
...
public class BlurView {
    ...
    private static volatile BlurView singleton = null;
    private Bitmap mBitmap;
    private int mRadius = 0;
    private float mScale = SCALE;
    private Context mContext;
    private BlurView.BlurPolicy mPolicy = BlurView.BlurPolicy.RS_BLUR;//默认使用rs 模糊图片
     ...
     * @return
     */
    public static BlurView with(Context context) {
        if (singleton == null) {
            synchronized (BlurView.class) {
                if (singleton == null) {
                    singleton = new BlurView(context);
                }
            }
        }
        return singleton;
    ...
    private BlurView(Context context) {
    ...
    public Bitmap blur() {
        ...
        if (SDK_INT > 8) {// support library running on 2.3(API 9)  and higher 算法
            if (mPolicy == BlurView.BlurPolicy.FAST_BLUR) {
     ...
     * @return
     */
    public BlurView policy(BlurPolicy policy) {
        this.mPolicy = policy;
        return this;
    }
     ...
     * @return
     */
    public BlurView bitmap(Bitmap bitmap) {
        this.mBitmap = bitmap;
        return this;
    }
     ...
     * @return
     */
    public BlurView scale(int scale) {
     ...
     * @return
     */
    public BlurView radius(int radius) {
        this.mRadius = radius;
        return this;
    }
    ...
    private static Bitmap blur(Bitmap bitmap, int radius) {
