...
import tv.hi_global.stbapi.Model.DiskModel;
import tv.hi_global.stbapi.Model.PartitonModel;
...
public class TabBarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlMedia = findViewById(R.id.urlmedia);
        ...
        SwitchCodeStream = findViewById(R.id.switchcodestream);
